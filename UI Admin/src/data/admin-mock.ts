...
export const APPEARANCE_SETTINGS = {
  site_name: "TH LOTTO II",
  site_tagline: "ระบบสลากและล็อตโต้ออนไลน์",
  site_badge: "มาตรฐานความปลอดภัยข้อมูล SSL 256-Bit",
  login_hero_heading: "ระบบสลากและล็อตโต้ออนไลน์ มาตรฐานความมั่นคงระดับสูง",
  login_feature_1: "ระบบคำนวณและปรับยอดรางวัลอัตโนมัติ แม่นยำทุกมาร์เก็ต",
  login_feature_2: "ถ่ายทอดสดสัญญาณผลรางวัลเรียลไทม์ โปร่งใส ตรวจสอบได้",
  login_feature_3: "ธุรกรรมการเงินอัตโนมัติ รวดเร็ว ปลอดภัย ได้รับการรับรอง",
  login_stat_1_val: "9",
  login_stat_1_label: "ตลาดหวยชั้นนำ",
  login_stat_2_val: "100%",
  login_stat_2_label: "การันตีความมั่นคง",
  ...
  login_badge_2_sub: "ปรับยอดทันที",
  login_badge_3_title: "ศูนย์บริการ",
  login_badge_3_sub: "ดูแล 24 ชม.",
  site_copyright: "© 2569 TH-LOTTO · สงวนลิขสิทธิ์ทุกประการ",
